          ...
          {!vehicleData ? (
            ...
            <>
              ...
              <div className="flex gap-4">
                <button
                  onClick={handleEditData}
                  className="flex-1 bg-[#1A1F2E] text-white py-4 rounded-lg border border-slate-700 hover:border-[#00D9FF] transition-all"
                >
                  Edit VIN
                </button>
                <button
                  ...
                  disabled={saving}
                  className="flex-2 w-full bg-[#00D9FF] text-[#0F1419] font-bold py-4 rounded-lg hover:bg-[#00C3E6] active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-[0_0_20px_rgba(0,217,255,0.4)] disabled:shadow-none flex items-center justify-center gap-2"
                >
                  {saving ? (
                    <>
                      <Loader2 className="w-5 h-5 animate-spin" />
