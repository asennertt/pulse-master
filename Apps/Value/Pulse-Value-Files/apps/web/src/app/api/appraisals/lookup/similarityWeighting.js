...
export function calculateSimilarityWeightedPrice({
  ...
  console.log(
    `[Similarity] Weighted price: $${weightedAvgPrice.toFixed(0)} from ${scoredComps.length} comparables (top similarity: ${(topWeight * 100).toFixed(1)}%)`,
  );

  return {
    price: Math.round(weightedAvgPrice),
