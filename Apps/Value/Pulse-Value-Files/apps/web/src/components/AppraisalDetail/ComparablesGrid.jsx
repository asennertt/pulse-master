    ...
    <div className="bg-[#0B1120] rounded-lg border border-slate-700/50 overflow-hidden hover:border-[#06b6d4]/50 transition-all group">
      ...
      <div className="p-4">
        <h4 className="text-white font-semibold text-sm mb-3 line-clamp-2">
          {yearValue} {comparable.make} {comparable.model} {trimValue}
        </h4>

        <div className="space-y-2">
          <div className="flex items-center gap-2 text-xs text-slate-400">
            <Gauge className="w-3 h-3 text-[#06b6d4]" />
            <span>{comparable.miles ? comparable.miles.toLocaleString() : "N/A"} miles</span>
          </div>
          <div className="flex items-center gap-2 text-xs text-slate-400">
            <MapPin className="w-3 h-3 text-[#06b6d4]" />
            <span>{comparable.dealer_name || comparable.location || "Location N/A"}</span>
          </div>
          <div className="flex items-center gap-2 text-xs text-slate-400">
            <Calendar className="w-3 h-3 text-[#06b6d4]" />
            <span>{comparable.dom || "N/A"} days on market</span>
          </div>
        </div>
        ...
        {comparable.url && (
          <a
            ...
            className="mt-3 block text-center text-xs text-[#06b6d4] hover:text-[#0891b2] font-semibold py-2 border border-[#06b6d4]/30 rounded-lg hover:border-[#06b6d4] transition-all"
          >
            View Listing
          </a>
        )}
