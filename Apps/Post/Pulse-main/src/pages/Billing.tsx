...
const planCards = [
  {
    ...
    features: [
      ...
      { text: "AI Smart Image Filtering", icon: BarChart3 },
      { text: "DMS Sync or Website Scraper", icon: Shield },
      { text: "Attribution Tracking", icon: BarChart3 },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Advanced Attribution Analytics", icon: BarChart3 },
