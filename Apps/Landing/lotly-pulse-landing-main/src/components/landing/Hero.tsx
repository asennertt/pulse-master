  ...
  return (
    <section
      ...
      <div ref={ref} className="reveal relative z-[2] text-center max-w-[720px] mx-auto">
        ...
        <h1 className="text-[clamp(40px,5.5vw,68px)] font-bold leading-[1.08] tracking-[-0.035em] text-foreground mb-5">
          ...
          <span className="inline-flex items-center justify-center gap-[0.15em]">
            ...
            <span className="pulse-logo-wrap">
              ...
              {/* SVG ECG trace overlay — follows the heartbeat line in the P */}
              <svg
        ...
        <p className="text-lg text-muted-foreground leading-relaxed max-w-[560px] mx-auto mb-9">Post your entire lot to Facebook Marketplace with AI descriptions and smart image sorting — and appraise vehicles instantly with live market data and VIN-powered valuations.
